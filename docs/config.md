...
### Rules
| Config                                             | Value                     | Required | Context dependent | Description                                                                                                                                                                                                                                                                                                                                                                                                                 |
|----------------------------------------------------|---------------------------|----------|-------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `rules`                                            | object                    | no       | no                |                                                                                                                                                                                                                                                                                                                                                                                                                             |
| `rules.allowSshSignatures`                         | `true` (default), `false` | no       | no                | `maintainers` and `contributors` are allowed to use SSH signatures                                                                                                                                                                                                                                                                                                                                                          |
| `rules.requireSshUserPresent`                      | `true`, `false` (default) | no       | no                | `maintainers` and `contributors` are required to touch security key when signing. Only `sk-ssh-ed25519@openssh.com` and `sk-ecdsa-sha2-nistp256@openssh.com` is supported and will fail on other key types.                                                                                                                                                                                                                 |
| `rules.requireSshUserVerified`                     | `true`, `false` (default) | no       | no                | `maintainers` and `contributors` are required to use PIN with security key when signing. Only `sk-ssh-ed25519@openssh.com` and `sk-ecdsa-sha2-nistp256@openssh.com` is supported and will fail on other key types.                                                                                                                                                                                                          |
| `rules.allowSshSha256`                             | `true`, `false` (default) | no       | no                | Allow SHA-256 to be used in the SSH signature.                                                                                                                                                                                                                                                                                                                                                                              |
| `rules.allowPgpSignatures`                         | `true` (default), `false` | no       | no                | `maintainers` and `contributors` are allowed to use PGP signatures                                                                                                                                                                                                                                                                                                                                                          |
| `rules.requireSignedTags`                          | `true` (default), `false` | no       | no                | Allow unsigned tags, `repository.exemptTags` is an alternative                                                                                                                                                                                                                                                                                                                                                              |
| `rules.requireMergeCommits`                        | `true` (default), `false` | no       | yes               | Require protected branches to use merge commits. Any conflicts must be resolved before merging.                                                                                                                                                                                                                                                                                                                             |
| `rules.requireCountersigning`                      | `true`, `false` (default) | no       | yes               | Require protected branches to use countersinging via mergetags. The committer and tagger must be different identities. The tree of the merge commit must be the same as the tree in the tagged commit.                                                                                                                                                                                                                      |
| `rules.requireSha512`                              | `true`, `false` (default) | no       | no                | Require SHA-512 in countersigned commits (via `Gitverify-object-sha512: <hex>` in the mergetag, which can be created using the [pr CLI](pr.md)). SHA-512 is also required in other places like `after.sha512`, `exemptTag.hash.sha512`. **For SSH, depending on the signature algorithm, SHA-256, SHA-384, or SHA-512 is used.** PGP is currently not supported. Regular tags and commits are not affected by this setting. |
| `rules.requireMatchedVersions`                     | `true`, `false` (default) | no       | yes               | Require the tag name to match `Gitverify-version` in the commit it points to.                                                                                                                                                                                                                                                                                                                                               |                                                                                                                                                                                                                                                                                                                                                                                                            |
| `rules.verifyAllCommits`                           | `true`, `false` (default) | no       | no                | All commits in the repository must have a valid signatures and be connected to `repository.after`.                                                                                                                                                                                                                                                                                                                          |
| `rules.trustForge`                                 | `true`, `false` (default) | no       | no                | Trust signatures made by `forgeIdentity`                                                                                                                                                                                                                                                                                                                                                                                    |
| `rules.requireDedicatedTagKeys`                    | `true`, `false` (default) | no       | no                | `{ssh,pgp}PublicKeys` used for tags cannot have other purposes.                                                                                                                                                                                                                                                                                                                                                             |
| `rules.requireDedicatedCountersignTagKeys`         | `true`, `false` (default) | no       | no                | `{ssh,pgp}PublicKeys` used for countersign tags cannot have other purposes.                                                                                                                                                                                                                                                                                                                                                 |
| `rules.requireDedicatedCountersignCommitKeys`      | `true`, `false` (default) | no       | no                | `{ssh,pgp}PublicKeys` used for countersign commits cannot have other purposes.                                                                                                                                                                                                                                                                                                                                              |
| `rules.requireDistinctTagIdentities`               | `true`, `false` (default) | no       | yes               | The identity used to sign a tag and the commit it points to cannot be the same.                                                                                                                                                                                                                                                                                                                                             | 
| `rules.requireDistinctCountersignTagIdentities`    | `true` (default), `false` | no       | yes               | The identity used to sign a countersign tag cannot be the same as the countersign commit and any tag pointing to the commit.                                                                                                                                                                                                                                                                                                |
| `rules.requireDistinctCountersignCommitIdentities` | `true` (default), `false` | no       | yes               | The identity used to sign a countersign commit cannot be the same as the countersign tag and any tag pointing to the commit.                                                                                                                                                                                                                                                                                                |
