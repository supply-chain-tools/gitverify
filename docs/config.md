...
| `identity.sshPublicKeys`             | list of SSH public keys | no       | Must be unique for a `repository`, same format as in SSH public files without the comment. `identity.tag.{ssh,pgp}PublicKeys` and `identity.countersign.{ssh,pgp}PublicKeys` keys can be specified to override these keys.                                         |
| `identity.pgpPublicKeys`             | list of PGP public keys | no       | Must be unique for a `repository`, only one PGP key is currently supported, standard armored string with newlines encoded as `\n`. `identity.tag.{ssh,pgp}PublicKeys` and `identity.countersign.{ssh,pgp}PublicKeys` keys can be specified to override these keys. |
| `identity.forgeUsername`             | string                  | no       | E.g. GitHub login name                                                                                                                                                                                                                                             |
| `identity.forgeUserId`               | string                  | no       | E.g. GitHub user id                                                                                                                                                                                                                                                |
| `identity.tag.sshPublicKeys`         | list of SSH public keys | no       | Keys used to check tags. Overrides any `identity.{ssh,pgp}PublicKeys`.                                                                                                                                                                                             |
| `identity.tag.pgpPublicKeys`         | list of PGP public keys | no       | Keys used to check tags. Overrides any `identity.{ssh,pgp}PublicKeys`.                                                                                                                                                                                             |
| `identity.countersign.sshPublicKeys` | list of SSH public keys | no       | Keys used to check countersigned commits. Overrides any `identity.{ssh,pgp}PublicKeys`.                                                                                                                                                                            |
| `identity.countersign.pgpPublicKeys` | list of PGP public keys | no       | Keys used to check countersigned commits. Overrides any `identity.{ssh,pgp}PublicKeys`.                                                                                                                                                                            |
...
| `rules.requireDedicatedTagKeys`         | `true`, `false` (default)  | no       | Only use `identity.tag` keys to validate tags.                                                                                                                                                                                                                                                                                                                                                                              |
| `rules.requireDedicatedCountersignKeys` | `true`, `false` (default)  | no       | Only use `identity.countersign` keys to validate countersigned commits.                                                                                                                                                                                                                                                                                                                                                     |
