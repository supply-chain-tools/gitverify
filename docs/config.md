...
| `rules.requireSha512`                              | `true`, `false` (default) | no       | tag, countersign commit                                     | Require SHA-512 in countersigned commits (via `Gitverify-object-sha512: <hex>` in the mergetag, which can be created using the [pr CLI](pr.md)). SHA-512 is also required in other places like `after.sha512`, `exemptTag.hash.sha512`. **For SSH, depending on the signature algorithm, SHA-256, SHA-384, or SHA-512 is used.** PGP is currently not supported. Regular tags and commits are not affected by this setting. |
| `rules.requireMatchedVersions`                     | `true`, `false` (default) | no       | tag -> commit, tag -> countersign commit                    | Require the tag name to match `Gitverify-version` in the commit it points to. For countersign commits the version must be in the countersign tag.                                                                                                                                                                                                                                                                           |                                                                                                                                                                                                                                                                                                                                                                                                            |
...
| `rules.requireDistinctTagIdentities`               | `true`, `false` (default) | no       | tag -> commit, tag -> countersign commit -> countersign tag | The identity used to sign a tag and the commit it points to cannot be the same.                                                                                                                                                                                                                                                                                                                                             | 
| `rules.requireDistinctCountersignTagIdentities`    | `true` (default), `false` | no       | tag -> countersign commit -> countersign tag                | The identity used to sign a countersign tag cannot be the same as the countersign commit and any tag pointing to the commit.                                                                                                                                                                                                                                                                                                |
| `rules.requireDistinctCountersignCommitIdentities` | `true` (default), `false` | no       | tag -> countersign commit -> countersign tag                | The identity used to sign a countersign commit cannot be the same as the countersign tag and any tag pointing to the commit.                                                                                                                                                                                                                                                                                                |
