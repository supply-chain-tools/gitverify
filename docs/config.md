...
| `rules.requireMatchedVersions`                     | `true`, `false` (default) | no       | anootated/lightweight tag -> commit, annotated/lightweight tag -> countersign commit | Require the tag name to match `Gitverify-version` in the commit it points to. For countersign commits the version must be in the countersign tag.                                                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                                                                                                                                                                            |
