...
| `rules.requireDistinctTagIdentities`               | `true`, `false` (default) | no       | The identity used to sign a tag and the commit it points to cannot be the same.                                                                                                                                                                                                                                                                                                                                             | 
| `rules.requireDistinctCountersignTagIdentities`    | `true` (default), `false` | no       | The identity used to sign a countersign tag cannot be the same as the countersign commit and any tag pointing to the commit.                                                                                                                                                                                                                                                                                                |
| `rules.requireDistinctCountersignCommitIdentities` | `true` (default), `false` | no       | The identity used to sign a countersign commit cannot be the same as the countersign tag and any tag pointing to the commit.                                                                                                                                                                                                                                                                                                |
