...
`
	...
	if repo0.Identities[0].SSHPublicKeys[0].Key != "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIIAQv90+kSOSKZYlMoWO0eX6QZ1Nt5n2BviA4vFx3lgK" {
		t.Errorf("repo0.Identities[0].SSHPublicKeys[0]=%q, want %q", repo0.Identities[0].SSHPublicKeys[0].Key, "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIIAQv90+kSOSKZYlMoWO0eX6QZ1Nt5n2BviA4vFx3lgK")
	}
	...
	if repo0.Rules.AllowPGPSignatures != true {
		t.Errorf("repo0.Rules.AllowPGPSignatures=%t, want %t", repo0.Rules.AllowPGPSignatures, true)
	}
	...
	if repo1.Identities[1].SSHPublicKeys[0].Key != "ecdsa-sha2-nistp256 AAAAE2VjZHNhLXNoYTItbmlzdHAyNTYAAAAIbmlzdHAyNTYAAABBBH2r8kV3iq50ugWjL3l4OaLEhGNUhMPc/A2UWQSix/I5XEG6sfnXZre06ROUF2DaWxiACUiLhO1UDUY0guun3ZQ=" {
		t.Errorf("repo1.Identities[0].SSHPublicKeys[0]=%q, want %q", repo1.Identities[1].SSHPublicKeys[0].Key, "ecdsa-sha2-nistp256 AAAAE2VjZHNhLXNoYTItbmlzdHAyNTYAAAAIbmlzdHAyNTYAAABBBH2r8kV3iq50ugWjL3l4OaLEhGNUhMPc/A2UWQSix/I5XEG6sfnXZre06ROUF2DaWxiACUiLhO1UDUY0guun3ZQ=")
	}
	...
	if repo1.Rules.AllowPGPSignatures != true {
		t.Errorf("repo1.Rules.AllowPGPSignatures=%t, want %t", repo1.Rules.AllowPGPSignatures, true)
	}
